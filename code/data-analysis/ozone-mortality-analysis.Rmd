...
save(out.base, 
     file = here('output', 'analysis', 'out-base.RDa'))
...
save(out.state, 
     file = here('output', 'analysis', 'out-state.RDa'))
...
save(out.ses, 
     file = here('output', 'analysis', 'out-ses.RDa'))
...
save(out.pm, 
     file = here('output', 'analysis', 'out-pm.RDa'))
...
save(out.no2, 
     file = here('output', 'analysis', 'out-no2.RDa'))
...
save(sex.F, 
     file = here('output', 'analysis', 'out-sexF.RDa'))
...
save(sex.M, 
     file = here('output', 'analysis', 'out-sexM.RDa'))
...
save(race.A, 
     file = here('output', 'analysis', 'out-raceA.RDa'))
...
save(race.B, 
     file = here('output', 'analysis', 'out-raceB.RDa'))
...
save(race.H, 
     file = here('output', 'analysis', 'out-raceH.RDa'))
...
save(race.W, 
     file = here('output', 'analysis', 'out-raceW.RDa'))
...
save(loc.urban, 
     file = here('output', 'analysis', 'out-urban.RDa'))
...
save(loc.suburban, 
     file = here('output', 'analysis', 'out-suburban.RDa'))
...
save(loc.rural, 
     file = here('output', 'analysis', 'out-rural.RDa'))
...
save(ses.Low, 
     file = here('output', 'analysis', 'out-sesL.RDa'))
...
save(ses.Mid, 
     file = here('output', 'analysis', 'out-sesM.RDa'))
...
save(ses.High, 
     file = here('output', 'analysis', 'out-sesH.RDa'))
...
save(ses.Low, 
     file = here('output', 'analysis', 'out-sesL-2.RDa'))
...
save(ses.Mid, 
     file = here('output', 'analysis', 'out-sesM-2.RDa'))
...
save(ses.High, 
     file = here('output', 'analysis', 'out-sesH-2.RDa'))
...
save(region.W, 
     file = here('output', 'analysis', 'out-west.RDa'))
...
save(region.MW, 
     file = here('output', 'analysis', 'out-midwest.RDa'))
...
save(region.S, 
     file = here('output', 'analysis', 'out-south.RDa'))
...
save(region.NE, 
     file = here('output', 'analysis', 'out-northeast.RDa'))
...
save(out.pm.bz12, 
     file = here('output', 'analysis', 'out-pm-bz12.RDa'))
...
save(out.pm.bz24, 
     file = here('output', 'analysis', 'out-pm-bz24.RDa'))
...
save(out.ses.8h, 
     file = here('output', 'analysis', 'out-ses-8hmax.RDa'))
...
save(out.ses.h, 
     file = here('output', 'analysis', 'out-ses-avgh.RDa'))
...
save(out.pm.8h, 
     file = here('output', 'analysis', 'out-pm-8hmax.RDa'))
...
save(out.pm.h, 
     file = here('output', 'analysis', 'out-pm-avgh.RDa'))
...
save(out.pm.brfss, 
     file = here('output', 'analysis', 'out-pm-brfss.RDa'))
