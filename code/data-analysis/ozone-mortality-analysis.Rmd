...
load(here('data','analysis','ndi-ozone-urbsub-sescat.RDa'))
load(here('data','analysis','ndi-ozone-bz12.RDa'))
load(here('data','analysis','ndi-ozone-bz24.RDa'))
...
save(out.base, file = here('output', 'analysis', 'out-base-4.RDa'))
```
...
save(out.state, file = here('output', 'analysis', 'out-state-4.RDa'))
```
...
save(out.ses, file = here('output', 'analysis', 'out-ses-4.RDa'))
```
...
save(out.pm, file = here('output', 'analysis', 'out-pm-4.RDa'))
```
...
save(out.no2, file = here('output', 'analysis', 'out-no2-4.RDa'))
```
...
save(age.le, file = here('output', 'analysis', 'out-le-4.RDa'))
...
save(age.mt, file = here('output', 'analysis', 'out-mt-4.RDa'))
...
save(ses.Low, file = here('output', 'analysis', 'out-sesL-II-4.RDa'))
...
save(ses.Mid, file = here('output', 'analysis', 'out-sesM-II-4.RDa'))
...
save(ses.High, file = here('output', 'analysis', 'out-sesH-II-4.RDa'))
```
...
save(out.pm.bz12, file = here('output', 'analysis', 'out-pm-bz12-4.RDa'))
```
...
save(out.pm.bz24, file = here('output', 'analysis', 'out-pm-bz24-4.RDa'))
```
...
save(out.ses.8h, file = here('output', 'analysis', 'out-ses-8hmax-4.RDa'))
```
...
save(out.ses.h, file = here('output', 'analysis', 'out-ses-avgh-4.RDa'))
```
...
save(out.pm.brfss, file = here('output', 'analysis', 'out-pm-brfss-7.RDa'))
```
...
save(race.A, file = here('output', 'analysis', 'out-raceA-7.RDa'))
...
save(race.B, file = here('output', 'analysis', 'out-raceB-7.RDa'))
...
save(race.W, file = here('output', 'analysis', 'out-raceW-7.RDa'))
