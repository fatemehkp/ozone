...
/*change . to 0*/
data prcs.master_ndi_ozone_race_n; set master_cuz;
...
proc export	data=prcs.master_ndi_ozone_race_n
	outfile='/scratch/fatemehkp/projects/Ozone/data/processed/master_ndi_ozone_race_n.csv'
	dbms=csv
	replace;
run;
